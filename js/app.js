(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function flipCard() {
            this.classList.toggle("_is-flipped");
        }
        cards.forEach((card => card.addEventListener("click", flipCard)));
        const textElements = document.querySelectorAll(".footer__check");
        let tooltipTimer;
            ...
            textElement.addEventListener("click", (event => {
                ...
                tooltipTimer = setTimeout((() => {
                    ...
                    tooltipElement.addEventListener("transitionend", (() => {
                        tooltipElement.classList.remove("_show");
        ...
        const observer = new IntersectionObserver((entries => {
            ...
            entries.forEach((entry => {
                if (entry.isIntersecting) document.querySelectorAll(".navigator").forEach((link => {
                    let id = link.getAttribute("href").replace("#", "");
                    if (id === entry.target.id) link.classList.add("_navigator-active"); else link.classList.remove("_navigator-active");
                }));
            }));
        }), {
            threshold: .5
